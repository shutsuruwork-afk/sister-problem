...
def tier0_static_analysis() -> bool:
    ...
    files = [
        ...
        "exp_h27_symbolic_ode.py",
        "exp_h45_fmm_multipole.py",
        ...
        "exp_h54_holographic_bulk.py",
        "exp_h58_lee_yang_zeros.py",
        "exp_h63_vnni_dotproduct.py",
        "exp_h64_cfg_cyk_grammar.py",
        "exp_h59_nf4_quantization.py",
        "exp_h62_abel_jacobi.py",
        "exp_h65_lut_only_adderless.py",
        ...
        "exp_h70_tensor_core_fp4.py",
        "exp_h69_cheeger_spectral.py",
        "exp_h76_swar_hash_sorter.py",
        "exp_h78_nvlink_svm.py",
        "exp_h74_avx512_fma_modulo.py",
        "exp_h72_cxl_prefetcher.py",
        "exp_h71_free_group_reduction.py",
        "exp_h80_fpga_bram_fifo.py",
        "exp_h75_betti_numbers.py",
        "exp_h77_gauss_schwarz_triangle.py",
        "exp_h84_avx512_popcnt.py",
        "exp_h92_swar_isolated_carry.py",
        "exp_h88_nvlink_allreduce.py",
        "exp_h86_fp16_modulo.py",
        "exp_h90_fpga_axi_stream.py",
        "exp_h85_discrete_morse.py",
        "exp_h89_tutte_polynomial.py",
        "exp_h96_green_function.py",
        "exp_h98_wavelet_compression.py",
        "exp_h87_dunkl_operators.py",
        "verify_all.py",
        "ranking.py",
        "dense.py",
    ]
